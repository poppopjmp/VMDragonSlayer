...
class PatternMatchViewer(QWidget):
    ...
    def setup_ui(self):
        ...
        self.pattern_filter.addItems(["All Patterns", "High Confidence", "VM Specific", "Control Flow"])
        ...
        self.pattern_tree.setHeaderLabels(["Pattern", "Confidence", "Category", "Description"])
    ...
    def refresh_pattern_display(self):
        ...
        for category, patterns in categories.items():
            ...
            for pattern in patterns:
                ...
                pattern_item.setText(3, description[:50] + "..." if len(description) > 50 else description)
    ...
    def apply_current_filter(self) -> List[Dict]:
        ...
        if filter_text == "All Patterns":
            ...
            return [p for p in self.pattern_matches if 'vm' in p.get('category', '').lower()]
        elif filter_text == "Control Flow":
            return [p for p in self.pattern_matches if 'control' in p.get('category', '').lower()]
    ...
    def show_pattern_details(self, pattern: Dict):
        ...
        details.append("")
        details.append(f"Description: {pattern.get('description', 'No description available')}")
...
class AnalysisTimelineWidget(QWidget):
    ...
    def add_timeline_event(self, event_type: str, description: str, timestamp: float = None):
    ...
    def refresh_timeline(self):
        ...
        sorted_events = sorted(self.timeline_events, key=lambda x: x['timestamp'], reverse=True)
...
class VMAnalysisResultsViewer(QWidget):
    ...
    def create_header(self) -> QWidget:
        ...
        self.title_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #1976D2;")
