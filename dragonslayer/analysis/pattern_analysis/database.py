...
class PatternDatabase:
    ...
    def _initialize_database(self):
        ...
        try:
            ...
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_vm_family ON patterns(vm_family)')
    ...
    def add_pattern(self, pattern: Union[PatternSample, tuple]) -> None:
        ...
        if isinstance(pattern, PatternSample):
            ...
            bytecode = features if isinstance(features, bytes) else str(features).encode()
    ...
    def search_patterns(self, 
                       ...
                       status: Optional[PatternStatus] = None) -> List[PatternSample]:
    ...
    async def match_patterns(self, data: bytes, 
                           threshold: float = 0.7,
                           max_matches: int = 100) -> List[PatternMatch]:
    ...
    def update_pattern(self, pattern_id: str, **updates) -> bool:
        ...
        allowed_fields = {
            'description', 'confidence', 'vm_type', 'status', 'metadata'
        }
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        for pattern in self.patterns.values():
            ...
            vm_family = pattern.vm_family
            stats['by_vm_family'][vm_family] = stats['by_vm_family'].get(vm_family, 0) + 1
    ...
    def _export_csv(self, file_path: str):
        ...
        with open(file_path, 'w', newline='', encoding='utf-8') as f:
            ...
            # Write header
            writer.writerow([
                'pattern_id', 'pattern_type', 'vm_family', 'confidence',
                'description', 'vm_type', 'status', 'usage_count'
            ])
        ...
        try:
            ...
            for pattern_data in data.get('patterns', []):
                try:
                    ...
                    logger.warning("Failed to import pattern %s: %s", 
                                  pattern_data.get('pattern_id', 'unknown'), e)
