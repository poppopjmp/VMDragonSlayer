...
from .config import get_config, VMDragonSlayerConfig
from .exceptions import (
    VMDragonSlayerError, AnalysisError, InvalidDataError, 
    ComponentNotFoundError, validate_not_none, validate_type
)
...
class VMDragonSlayerAPI:
    ...
    def analyze_binary_data(self, binary_data: bytes, analysis_type: str = "hybrid",
        ...
        try:
            ...
            self.logger.info(f"Binary analysis completed: {request.request_id} "
    ...
    async def analyze_binary_data_async(self, binary_data: bytes, 
        ...
        try:
            ...
            self.logger.info(f"Async binary analysis completed: {request.request_id} "
                           f"(success: {result.success})")
    ...
    def execute_symbolically(self, file_path: str, **options) -> Dict[str, Any]:
        ...
        """
        return self.analyze_file(file_path, analysis_type="symbolic_execution", **options)
