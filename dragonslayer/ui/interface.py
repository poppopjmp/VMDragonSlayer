...
class UIInterface:
    ...
    def create_button(self, text: str, onClick: Optional[callable] = None,
                     variant: str = 'primary', size: str = 'medium') -> Dict[str, Any]:
    ...
    def create_card(self, title: str, content: Any, 
                   actions: Optional[List[Any]] = None) -> Dict[str, Any]:
    ...
    def create_alert(self, message: str, alert_type: str = 'info',
                    dismissible: bool = False) -> Dict[str, Any]:
    ...
    def create_progress_bar(self, value: float, max_value: float = 100,
                           show_label: bool = True, variant: str = 'primary') -> Dict[str, Any]:
    ...
    def create_spinner(self, size: str = 'medium', variant: str = 'primary') -> Dict[str, Any]:
    ...
    def create_badge(self, text: str, variant: str = 'secondary') -> Dict[str, Any]:
        ...
        return {
            'type': 'span',
            'className': f'badge bg-{variant}',
            'children': text
        }
    
    def create_table(self, headers: List[str], rows: List[List[Any]],
                    striped: bool = True, hover: bool = True) -> Dict[str, Any]:
